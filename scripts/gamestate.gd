...
const DEFAULT_CHARACTER_SELECTED = 3
...
var url = "wss://multiplayer-ranged-server-1036179882263.europe-west1.run.app:443"
# var url = "ws://192.168.1.116:10567"
...
func _ready():
	...
	# Allows to not have to change manually the URL for export to remote server
...
remote func addPlayer(new_player_name):
	...
	players[id] = {"name": new_player_name, "ready": false, "char_index": DEFAULT_CHARACTER_SELECTED}
...
remotesync func start_game():
	...
	# Change scene.
	var world = load("res://scenes/RangedWorld.tscn").instance()
...
# 	# var player_scene = load("res://scenes/Player_ranged.tscn")
...
# 		if char_index == 3:
# 			player_scene = load("res://scenes/Player_ranged.tscn")
# 		else:
...
remote func disconnectClient():
	print("gamestate.gd - disconnectClient - Disconnecting client")
	EventBus.emit_signal("game_ended_on_server")
